  // Initialize Firebase
  var config = {
    apiKey: "AIzaSyDbypG0kZK-pG-5ArT577pTQa0vpm6jNgg",
    authDomain: "iadb-ca686.firebaseapp.com",
    databaseURL: "https://iadb-ca686.firebaseio.com",
    projectId: "iadb-ca686",
    storageBucket: "",
    messagingSenderId: "769521150154"
  };
    ...
    $.each(data, function(index, article){
      ...
      if(index === 0){
        ...
        `<div id="`+article.id+`" class="item item--alpha">   
            <a href="article.html?=`+article.id+`" class="item-imagecontainer">
              <img src="" alt="" class="item-imagecontainer-image">
              <div class="image-overlay"></div>
            </a>
            <div class="textbox">
              <h2 class="item-title"><a href="article.html?=`+article.id+`" ></a></h2>
